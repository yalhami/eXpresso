<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="ContactUs_UC.ascx.cs"
    Inherits="TG.ExpressCMS.UI.InQuiries.ContactUs_UC" %>
<%@ Register src="InQuiryViewer_UC.ascx" tagname="InQuiryViewer_UC" tagprefix="uc1" %>
            ...
            <tr style="display: none;">
                <td>
                    <asp:RadioButton ID="cu" runat="server" Text="اقتراحات او سبب اخر" GroupName="A"
                        Checked="true" />
                    <asp:RadioButton ID="fa" runat="server" Text="طلب فتوى" GroupName="A" />
                </td>
            </tr>
            <%--   <tr>
                <td>
