<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="VideoAdmin_UC.ascx.cs"
    Inherits="TG.ExpressCMS.UI.Custums.VideoAdmin_UC" %>
...
<div class="header">
    <h3>
        <asp:Label ID="lblNewsPage" runat="server" Text="Videos Manager"></asp:Label>
    </h3>
</div>
...
<asp:UpdatePanel ID="upnlGrid" runat="server" UpdateMode="Conditional">
    <ContentTemplate>
        <asp:PlaceHolder ID="plcGridView" runat="server">
            ...
            <div class="gridTitle">
                <asp:Label ID="lblGrdTitleNews" runat="server" Text="Videos Entries"></asp:Label>
            </div>
            <div style="background: white; overflow: auto; width: 100%; height: 100%;">
                <asp:GridView ID="gvNews" runat="server" AllowPaging="true" PageSize="10" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField>
                            ...
                            <ItemTemplate>
                                <asp:ImageButton ID="ibtnStatus" Width="15" Height="15" runat="server" CommandArgument='<%#DataBinder.Eval(Container,"DataItem.ID")%>'
                                    CommandName="pub" ImageUrl='<%#GetImageUrl(DataBinder.Eval(Container,"DataItem.PublishFrom").ToString(),DataBinder.Eval(Container,"DataItem.PublishTo").ToString()) %>'
                                    ToolTip='<%#GetToolTip(DataBinder.Eval(Container,"DataItem.PublishFrom").ToString(),DataBinder.Eval(Container,"DataItem.PublishTo").ToString()) %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField>
