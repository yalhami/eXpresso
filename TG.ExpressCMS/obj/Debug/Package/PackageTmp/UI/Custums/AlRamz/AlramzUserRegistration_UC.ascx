...
<asp:Panel ID="pnlFirst" runat="server">
    <table>
        ...
        <tr>
            <td class="Reqiured">
                *
                <asp:Label ID="Label2" Text='<%$Resources:ExpressCMS,lblReqiured %>' runat="server"></asp:Label>
            </td>
            <td>
            </td>
        </tr>
...
<asp:Panel ID="pnlIndividuals" runat="server">
    <table>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RegularExpressionValidator ID="revEmail" runat="server" ControlToValidate="txtEmail"
                    ValidationGroup="Regiter" Display="None" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator Display="Static" ID="rfvProfession" runat="server" ControlToValidate="txtProfession"
                    ValidationGroup="valIndividuals" Enabled="false" Text="*" ErrorMessage='<%$Resources:ExpressCMS,lblProfession %>'></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td class="Reqiured">
                *
                <asp:Label ID="Label3" Text='<%$Resources:ExpressCMS,lblReqiured %>' runat="server"></asp:Label>
            </td>
        </tr>
    </table>
    <div class="actions">
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RegularExpressionValidator ID="regComEmail" Display="None" runat="server" ControlToValidate="txtComEmail"
        ...
        <tr>
            <td class="Reqiured">
                *
                <asp:Label ID="Label4" Text='<%$Resources:ExpressCMS,lblReqiured %>' runat="server"></asp:Label>
            </td>
        </tr>
    </table>
    <div class="actions">
...
<asp:Panel ID="pnlProxyTrustee" runat="server">
    <table>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator Display="Static" ID="RequiredFieldValidator7" runat="server"
                    ...
                    ErrorMessage='<%$Resources:ExpressCMS,lblPrProfession %>' Enabled="false"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtComEmail"
                    ValidationGroup="txtPrEmail" Display="None" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"
                    ErrorMessage='<%$Resources:ExpressCMS,validEmail %>'>*</asp:RegularExpressionValidator>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="Reqiured">
                *
                <asp:Label ID="Label5" Text='<%$Resources:ExpressCMS,lblReqiured %>' runat="server"></asp:Label>
            </td>
        </tr>
    </table>
    <div class="actions">
...
<asp:Panel ID="pnlJointAccount" runat="server">
    <table>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator Display="Static" ID="rfvJointProffession" runat="server"
                    ControlToValidate="txtJointProffession" Enabled="false" ValidationGroup="vaJoint"
                    Text="*" ErrorMessage='<%$Resources:ExpressCMS,lblJointProffession %>'></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td class="Reqiured">
                *
                <asp:Label ID="Label6" Text='<%$Resources:ExpressCMS,lblReqiured %>' runat="server"></asp:Label>
            </td>
        </tr>
    </table>
    <div class="actions">
...
<asp:Panel runat="server" ID="pnlelAccount">
    <table>
        ...
        <tr>
            ...
            <td>
                <asp:CheckBoxList runat="server" ID="chkHowUcome">
        ...
        <tr>
            <td class="Reqiured">
                *
                <asp:Label ID="Label7" Text='<%$Resources:ExpressCMS,lblReqiured %>' runat="server"></asp:Label>
            </td>
        </tr>
    </table>
    <div class="actions">
...
<asp:Panel ID="pnlStep6" runat="server">
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <asp:FileUpload ID="rtAllPapers" runat="server" />
            </td>
        </tr>
    </table>
    <br />
