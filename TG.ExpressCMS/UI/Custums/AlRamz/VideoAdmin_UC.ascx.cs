...
{
    public partial class VideoAdmin_UC : System.Web.UI.UserControl
    {
        /// <summary>
        /// Object ID.
        /// </summary>
        ...
        {
            BindGrid(10000);
            UtilitiesManager.GenerateExcelFiles("Videos", gvNews);
        }
        ...
        void btnSaveUpdate_Click(object sender, EventArgs e)
        {
            ...
            if (ObjectID <= 0)
            {
                try
                {
                    ...
                    newsItems.Details = txtDetails.Content;
                    ...
                    newsItems.Image = UtilitiesManager.GetSavedFile(fUploader, true);
        ...
        private void EditMode()
        {
            if (ObjectID > 0)
            {
                ...
                txtDetails.Content = newsItems.Details;
        ...
        private void FillDDL()
        {
            ...
            ddlSearchCategories.DataSource = ddlCategories.DataSource = CategoryManager.GetAll().Where(t => t.Type == RootEnums.CategoryType.AlRamzVideos).ToList();
