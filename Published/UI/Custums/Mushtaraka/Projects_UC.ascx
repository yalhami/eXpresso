        ...
        <asp:PlaceHolder ID="plcControls" runat="server">
            <table width="100%">
                ...
                <tr style="display: none;">
                    ...
                    <td>
                        <asp:DropDownList ID="ddlCategoryType" runat="server" Width="254" Enabled="false">
                        </asp:DropDownList>
                        <asp:RequiredFieldValidator ID="rfvCatType" runat="server" ControlToValidate="ddlCategoryType" Enabled="false"
